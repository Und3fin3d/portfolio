...
A portfolio that proves instead of claims: the projects on the CV run live in the page. This is the notebook design (design 2); the solar-system design lives at the repository root.
...
Deployed at `https://williamgreenfield.com/design2/`.
